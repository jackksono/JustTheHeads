...
const ContactUs = (props) => {
    ...
    return (props.trigger) ? (
        <div className="fixed overflow-auto lg:inset-x-0 lg:mx-auto w-84 lg:w-1/2 lg:h-[720px] bg-orange-500 bg-opacity-80 rounded-xl shadow-2xl duration-500" ref={clickAway} >
       
        <form className="" method="post" onSubmit={sendMail}>
            <div className='flex justify-end pr-5 text-2xl text-black duration-100 hover:text-white'>    
                <button  onClick={() => props.setTrigger(false)}>X</button>
            </div>
            <h1 className="flex justify-center pl-10 pr-10 text-2xl text-white lg:text-4xl">How's The <span className="justify-center italic text-red-700 underline">Head?</span></h1>
            
                
            <div className="pl-6 text-lg italic text-black">
                <span className="pl-3 text-sm lg:text-xl">Name (required)</span>
            ...
            <div className="pl-6 text-lg italic text-black">
                <span className="pl-3 text-sm lg:text-xl">Email (required)</span>
            ...
            <div className="pl-6 text-lg italic text-black">
                <span className="pl-3 text-sm lg:text-xl">Phone#</span>
            ...
            <div className="pl-6 text-lg italic text-black">
                <span className="pl-3 text-sm lg:text-xl">Message (required)</span>
            ...
            <div className="items-center justify-center text-center lg:py-5">
                <button 
                    className="w-1/5 p-2 h-[40px] text-black lg:w-1/4 bg-white rounded-xl hover:text-white hover:bg-black" type='submit'>Send
