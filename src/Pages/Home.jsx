...
const Home = () => {
    ...
    return (
        <div>
            <div className="overflow-auto overflow-x-hidden bg-orange-200 bg-center bg-cover shadow-lg lg:w-screen bg-drop-shadow-4xl bg-smoke bg-texture bg-blend-color-burn ">
