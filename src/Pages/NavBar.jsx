...
const NavBarComponent = () => {
  ...
  return (
      ...
      <>
      <Headroom>
        <nav class="w-screen p-2 top-0 lg:static fixed inset-x-0 bg-orange-200 h-[100px] drop-shadow-2xl bg-bubbles bg-texture bg-cover bg-center bg-blend-overlay justify-content-end z-10"
        ref={clickAway}>
            <div className="flex px-5 lg:justify-between lg:px-20 lg:mt-1">
                  <span className="italic text-black lg:text-sm text-[12px] bg-primary-500">
                    ...
                    <p className="mx-5 lg:mx-8 lg:text-lg text-dark-mode-black">Questions? Holla At Us @ xxx-xxx-xxxx</p>
                  </span>             
