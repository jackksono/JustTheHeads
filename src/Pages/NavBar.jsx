...
const NavBarComponent = () => {
  ...
  return (
      ...
      <>
      <Headroom>
        <nav class="w-screen p-2 top-0 lg:static fixed inset-x-0 bg-color-darkOrange h-[100px] drop-shadow-2xl bg-navBarBackground bg-texture bg-left-bottom bg-cover bg-blend-overlay justify-content-end z-10"
        ref={clickAway}>
                        ...
                        <button className="flex text-right text-black transition duration-150 ease-in-out bg-primary-500 hover:text-white hover:scale-125 focus:text-white">
                            <BsFillCartFill className="text-lg lg:w-[27.5px] lg:h-[27.5px]"/>
                              ...
                              <div className="relative w-[20px] h-[30px]">
                                <h1 className="relative justify-center text-center text-black rounded-full bg-red-500 text-[10px]">{productCount}</h1>
                              </div> 
                              : 
                              <></>}                         
                        </button>
            ...
            <div class="nav-links  bg-blackPaper w-[360px] lg:bg-none lg:bg-transparent duration-500 lg:static lg:h-0  lg:flex-row flex-col  lg:pt-10 lg:px-10 lg:block lg:w-auto">
              <ul class="font-medium left-0 lg:flex lg:justify-between w-full lg:h-full lg:px-20 p-4 lg:p-0 mt-4 pb-4 gap-4 lg:flex-row lg:space-x-8 lg:mt-0">
                  <div className="flex items-center lg:bg-transparent lg:gap-10 ">
                    <Link to="/">
                      <button className="text-[10px] lg:text-xl lg:font-semibold lg:duration-200 bg-primary-500 text-black  hover:text-orange-900 font-Kanit focus:text-black focus:rounded-lg focus:transform focus:scale-[1.1]"
                      onClick={toggleOff}>
                        Home
                      </button>
                    </Link>
                  ...
                  <div className="left-0 flex flex-col lg:flex-row lg:bg-transparent lg:items-center lg:flex-non lg:gap-10">
                    ...
                    <Link to="/all-products">
                      <button className="text-[10px] lg:text-xl lg:font-semibold lg:duration-200 md:bg-primary-500 text-black  hover:text-orange-900 font-Kanit focus:text-black focus:rounded-lg focus:transform focus:scale-[1.1]"
