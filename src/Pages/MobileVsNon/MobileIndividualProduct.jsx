...
const MobileIndividualProduct = () => {
  ...
  return (
    ...
    <div className='flex lg:w-[700px] mx-5 sm:mx-0 justify-center w-full p-2 h-auto lg:h-[400px] items-center shadow-[0px_3px_15px_rgba(0,0,0,0.2)] rounded-[25px]  lg:ml-20 lg:p-5 bg-transparent'>
