        ...
        <>
            <div className="flex flex-col justify-center p-1 items-center w-[150px] lg:w-[300px] lg:h-[350px] lg:m-[100px] rounded-b-2xl" >
                <div className="blob-toggle absolute z-{-1} bg-center mb-32 lg:h-[500px] lg:w-[500px] duration-1000 opacity-90 "></div>
                    ...
                    :
                    <button className=" z-0 text-[10px] font-CabinSketch font-bold w-[100px] lg:text-sm text-center border-2 border-color-secondary bg-color-primary rounded-lg text-white hover:bg-black hover:text-color-secondary cursor-pointer lg:min-w-[100px] lg:px-2 lg:py-1 lg:mt-2 duration-100"
                        onClick={(e) => {
