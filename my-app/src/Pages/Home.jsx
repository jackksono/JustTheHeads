    ...
    return (
        ...
        <div className="overflow-auto bg-orange-200 bg-center bg-cover shadow-lg bg-drop-shadow-4xl bg-smoke bg-texture bg-blend-color-burn ">
            <div className="justify-center">
                ...
                className="w-[414px] h-[300px] justify-center lg:w-screen md:h-screen lg:bg-no-repeat bg-cover bg-center rounded-2xl opacity-95">
                </div>
                {/* Left Arrow */}
            ...
            <div className="w-full lg:aspect-[960/300]   grid grid-cols-2 lg:pt-20 pt-4  shadow-black px-4 shadow-md bg-blackPaper bg-cover bg-no-repeat bg-center">
                    ...
                    <img src={Welcome} alt="bag" className="content-center items-center pt-4 justify-center lg:w-3/4 lg:h-[300px] w-[300px] h-[150px] shadow-lg rounded-lg shadow-black"></img>     
            </div>
            <div >
